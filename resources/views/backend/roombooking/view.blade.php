...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <p>
            <form action="{{ url('admin/roombooking/' . $roombooking->id) }}" style="display:inline;" method="POST">
                <input type="hidden" name="_method" value="DELETE" />
                {{ csrf_field() }}
                <button class="btn btn-danger" type="submit"><span class="glyphicon glyphicon-trash"></span> Delete</button>
            </form>
            <a class="btn btn-primary" href="{{ url('admin/roombooking/' . $roombooking->id . '/edit')}}">
