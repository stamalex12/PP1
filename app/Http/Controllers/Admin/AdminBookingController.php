...
class AdminBookingController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'page_title' => 'Full Booking List',
            'roombooking'=> RoomBooking::orderBy('startDate')->get(),
        ];
        return view('backend/roombooking/list', $data);
    ...
    public function store(Request $request)
    {
        ...
        if ($check !=false) {
            ...
            return redirect('backend/roombooking/create');
        }
        else{
    ...
    public function show($id)
    {
        $roombooking = RoomBooking::findOrFail($id);
            ...
            return view('backend/roombooking/view', $data);
    }
    ...
    public function edit($id)
    {
        $roombooking = RoomBooking::findOrFail($id);
            ...
            return view('backend/roombooking/edit', $data);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($check !=false){
            ...
            return redirect('admin/roombooking');
        }
